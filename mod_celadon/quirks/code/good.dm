/datum/quirk/fan_clown
	...
	gain_text = span_notice("You are a big fan of clowns.</span>"
	lose_text = span_danger("The clown doesn't seem so great.</span>"
...
/datum/quirk/fan_mime
	...
	gain_text = span_notice("You are a big fan of the Mime.</span>"
	lose_text = span_danger("The mime doesn't seem so great.</span>"
