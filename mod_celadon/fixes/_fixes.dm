/datum/modpack/fixes
	...
	desc = "Содержит различные фиксы багов. \
			...
			фикс оффовской одежды c закатываемыми руками в атласе - icons/obj/clothing/under/security.dmi "// TODO сделать ПР для офовичные фиксы багов. Фикс удушья при пустом баллоне. Сломанные иконки. Исправление работы плазма двигателей,фикс зарядки револьверов, фикс дюпа боргов, фикс сломанных шаттерсов" // TODO сделать ПР для офов
	author = "RalseiDreemuurr, Mirag1993, Корольный крыс, MrCat15352, MysticalFaceLesS, GrozaAndGrom, MrRomainzZ, Yata9arasu, Redwizz777, Ganza9991, Cuildipie"
