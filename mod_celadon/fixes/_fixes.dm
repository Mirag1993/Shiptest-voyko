/datum/modpack/fixes
	...
	desc = "Содержит различные фиксы багов. \
			...
			фикс перезарядки мех-оружия (SOB-3, BRM-6, SGL-6)" // TODO сделать ПР для офовичные фиксы багов. Фикс удушья при пустом баллоне. Сломанные иконки. Исправление работы плазма двигателей,фикс зарядки револьверов, фикс дюпа боргов, фикс сломанных шаттерсов" // TODO сделать ПР для офов
