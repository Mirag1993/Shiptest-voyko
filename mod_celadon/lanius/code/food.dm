...
/obj/item/stack/sheet/metal/attack(mob/living/M, mob/living/user, def_zone)
	...
	if(islanius(M))
		if(M.nutrition > (600))	// The more you eat - the more you can eat
			user.visible_message(span_warning("[user] cannot force any more of \the [src] to go down [user.p_their()] throat!</span>", span_warning("You cannot force any more of \the [src] to go down your throat!"))
			return FALSE
